      ...
      >
        <div class="py-1">
          <template v-if="account">
            ...
            <button v-if="account.type === 'apikey'" data-test="copy-account" @click="$emit('copy', account); $emit('close')" class="flex w-full items-center gap-2 px-4 py-2 text-sm text-blue-600 hover:bg-gray-100 dark:hover:bg-dark-700">
